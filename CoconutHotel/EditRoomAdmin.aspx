<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="EditRoomAdmin.aspx.cs" Inherits="CoconutHotel.EditRoomAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="editRoomForm" runat="server" CssClass="edit-form">
        <h2>Edit Room</h2>
