<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddProfileAdmin.aspx.cs" Inherits="CoconutHotel.AddProfileAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="addUserProfileForm" runat="server" CssClass="add-form">
